...
- `collate_project_sessions_energy` -- every Codex chat in the current project.

This guidance only applies within this repo unless you also copy it into your
global `~/.codex/AGENTS.md` -- see the Codex section of README.md.
